(() => {
  ...
  const strings = {
    pt: {
      ...
      "features.sub":
        "Assistente Always-On-Top para a comunidade — catálogo offline, atalhos globais, zero acesso ao jogo.",
      ...
      "features.evidence.body":
        "Filtre 30 fantasmas por evidência e velocidade. The Mimic inclui Orb falsa, como no jogo.",
      "features.pec.title": "Peculiaridades",
      "features.pec.body":
        "Shift+1 Demon cooldown, Shift+2 Incenso (3 min), Shift+3 ciclo Obambo paz/agressivo.",
      "features.ui.title": "Overlay compacto",
      "features.ui.body":
        "Janela por cima do jogo, modo compacto, transparência e escala salvos localmente.",
      ...
      "how.s3.body": "Veja média, padrão (estável/acelerando/…) e fantasmas compatíveis.",
      "how.s4.title": "Marque evidências",
      "how.s4.body":
        "Refine o filtro e use peculiaridades (Shift+1/2/3) conforme a investigação.",
      ...
      "download.meta3": "Código aberto no repositório do projeto",
    ...
    en: {
      ...
      "features.sub":
        "An Always-On-Top community assistant — offline catalog, global hotkeys, zero game access.",
      ...
      "features.evidence.body":
        "Filter 30 ghosts by evidence and speed. The Mimic includes the fake Orb, like in-game.",
      "features.pec.title": "Peculiarities",
      "features.pec.body":
        "Shift+1 Demon cooldown, Shift+2 Incense (3 min), Shift+3 Obambo peace/angry cycle.",
      "features.ui.title": "Compact overlay",
      "features.ui.body":
        "Sits on top of the game with compact mode, opacity and UI scale saved locally.",
      "how.eyebrow": "FIELD GUIDE",
      ...
      "how.s3.body": "See average, pattern (stable/speeding up/…) and matching ghosts.",
      "how.s4.title": "Mark evidence",
      "how.s4.body":
        "Tighten the filter and use peculiarities (Shift+1/2/3) as the investigation goes.",
      "download.eyebrow": "RELEASE",
      ...
      "download.meta3": "Open source in the project repository",
      "disclaimer.eyebrow": "CLEARANCE",
